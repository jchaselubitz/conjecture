...
import { BaseProfile, FollowWithFollowed, FollowWithFollower } from 'kysely-codegen';
...
export const getUserProfile = async (slug?: string): Promise<BaseProfile | null | undefined> => {
